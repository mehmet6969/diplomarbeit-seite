...
@app.route('/fraesen_info')
def fraesen_info():
    return render_template('Info/fraesen_info.html')
...
@app.route('/ai_assistent_info')
def ai_assistent_info():
    return render_template('Info/ai_assistent_info.html')

@app.route('/ai_assistent_projekte')
def ai_assistent_projekte():
    return render_template('Projekte/ai_assistent_projekte.html')
